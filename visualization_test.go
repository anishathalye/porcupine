...
func TestVisualizationMultipleLengths(t *testing.T) {
	...
	expected := []partitionVisualizationData{{
		History: []historyElement{
			{ClientId: 0, Start: 0, OriginalStart: "0", End: 1300, OriginalEnd: "100", Description: "get('x') -> 'w'", Id: 0, FirstConc: []int{0, 0, 0, 0, 0, 0}},
			{ClientId: 1, Start: 100, OriginalStart: "5", End: 200, OriginalEnd: "10", Description: "put('x', 'y')", Id: 1, FirstConc: []int{0, 0, 0, 0, 0, 0}},
			{ClientId: 2, Start: 0, OriginalStart: "0", End: 200, OriginalEnd: "10", Description: "put('x', 'z')", Id: 2, FirstConc: []int{0, 0, 0, 0, 0, 0}},
			{ClientId: 1, Start: 300, OriginalStart: "20", End: 500, OriginalEnd: "30", Description: "get('x') -> 'y'", Id: 3, FirstConc: []int{0, 0, 1, 0, 0, 0}},
			{ClientId: 1, Start: 600, OriginalStart: "35", End: 800, OriginalEnd: "45", Description: "put('x', 'w')", Id: 4, FirstConc: []int{0, 0, 1, 0, 0, 0}},
			{ClientId: 5, Start: 400, OriginalStart: "25", End: 600, OriginalEnd: "35", Description: "get('x') -> 'z'", Id: 5, FirstConc: []int{0, 1, 1, 0, 0, 0}},
			{ClientId: 3, Start: 500, OriginalStart: "30", End: 700, OriginalEnd: "40", Description: "get('x') -> 'y'", Id: 6, FirstConc: []int{0, 1, 1, 0, 0, 0}},
		},
		...
		History: []historyElement{
			{ClientId: 4, Start: 900, OriginalStart: "50", End: 1200, OriginalEnd: "90", Description: "get('y') -> 'a'", Id: 0, FirstConc: []int{0, 0, 0, 0, 0, 0}},
			{ClientId: 2, Start: 1000, OriginalStart: "55", End: 1100, OriginalEnd: "85", Description: "put('y', 'a')", Id: 1, FirstConc: []int{0, 0, 0, 0, 0, 0}},
		},
		PartialLinearizations: []partialLinearization{
			{{1, "a"}, {0, "a"}},
		},
